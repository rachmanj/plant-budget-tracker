...
- `[done] P1: Phase 1 — Budget Management (ledger-based): budget_periods/allocations/ledgers migrations, BudgetEngine, VarianceCalculator, CarryForwardJob, BudgetController, policies, Budget/Index+Setting UI, 14 new tests [docs/plan.md §Phase 1] (completed: 2026-08-04)`
...
- `[ ] P1: Phase 2 — Plant Request + Approval Workflow [docs/plan.md §Phase 2]`
