...
class RoleAndPermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $matrix = [
            ...
            'project_manager' => ['budget.view', 'plant_request.approve.pm', 'plant_request.receive', 'dmbd.view', 'cancellation.plant', 'reports.view'],
            'plant_manager' => ['budget.view', 'plant_request.approve.plant_mgr', 'plant_request.receive', 'dmbd.view', 'cancellation.plant', 'cannibal.approve.1', 'component.view', 'reports.view', 'reports.export'],
