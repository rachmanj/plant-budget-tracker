...
class RoleAndPermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $matrix = [
            ...
            'buyer' => ['budget.view', 'tabulation_bid.create', 'cancellation.procurement', 'interchange.manage', 'reports.view', 'procurement.view'],
            'procurement_manager' => ['budget.view', 'tabulation_bid.review', 'cancellation.procurement', 'interchange.manage', 'reports.view', 'reports.export', 'procurement.view', 'procurement.sync'],
            'procurement_admin' => ['budget.view', 'po.create', 'cancellation.procurement', 'interchange.manage', 'reports.view', 'procurement.view', 'procurement.sync'],
            ...
            'it_manager' => ['budget.view', 'project.setup', 'user.manage', 'dmbd.view', 'reports.view', 'procurement.view', 'procurement.sync'],
