...
class RoleAndPermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $matrix = [
            ...
            'project_manager' => ['budget.view', 'plant_request.approve.pm', 'plant_request.receive', 'dmbd.view', 'cancellation.plant', 'reports.view', 'procurement.view'],
            'plant_manager' => ['budget.view', 'plant_request.approve.plant_mgr', 'plant_request.receive', 'dmbd.view', 'cancellation.plant', 'cannibal.approve.1', 'component.view', 'reports.view', 'reports.export', 'procurement.view'],
            'buyer' => ['budget.view', 'tabulation_bid.create', 'cancellation.procurement', 'interchange.manage', 'reports.view', 'procurement.view', 'po.attach'],
            'procurement_manager' => ['budget.view', 'tabulation_bid.review', 'cancellation.procurement', 'interchange.manage', 'reports.view', 'reports.export', 'procurement.view', 'procurement.sync', 'po.attach'],
            'procurement_admin' => ['budget.view', 'po.create', 'cancellation.procurement', 'interchange.manage', 'reports.view', 'procurement.view', 'procurement.sync', 'po.attach'],
            ...
            'it_manager' => ['budget.view', 'project.setup', 'user.manage', 'dmbd.view', 'reports.view', 'procurement.view', 'procurement.sync', 'po.attach'],
