...
export default function Create({
    ...
    const { data, setData, post, processing, errors } = useForm({
        budget_allocation_id: allocations.length === 1 ? allocations[0].id : (null as number | null),
        equipment_id: prefill.equipment_id ?? 0,
        unit_code_cache: prefill.unit_code_cache ?? prefillEquipment?.unit_code ?? '',
        ...
        lines: [
            {
                ...
                qty: 1,
                unit_price_est: '',
                price_source: 'none' as PriceSource,
            },
        ] as LineItem[],
    });
